...
const DEFAULT_TIMEOUTS = {
  ...
  SEARCH_REQUEST: 20 * 60 * 1000,       // 20 minutes for primary search requests (very long-running allowed)
  SEARCH_FOLLOWUP: 10 * 60 * 1000,      // 10 minutes for follow-up questions
